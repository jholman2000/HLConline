<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/HLC.Master" CodeBehind="EditPractice.aspx.vb" Inherits="HLConline.EditPractice" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="2" cellspacing="0" width="100%">
        <tr>
            <td>
    <asp:Label ID="lblHeading" runat="server" CssClass="ContentHeading" Text="Add a Practice"></asp:Label></td>
            <td align="right">
    ...
    <asp:Panel ID="pnlError" runat="server" Height="50px" Width="580px" BorderColor="Red" BorderStyle="Solid" BorderWidth="1px" Visible="False" BackColor="Cornsilk">
        ...
        <asp:Image ID="Image1" runat="server" ImageAlign="Middle" ImageUrl="~/images/error_big.gif" />&nbsp;<strong><br />
            ...
            <td valign="top">
                Unable to update this Practice because of the following:<br />
    ...
    <table style="width: 100%" id="TABLE1">
        <tr>
            <td style="width: 96px" valign="top">
                <asp:Label ID="Label6" runat="server" CssClass="LabelDataEntry" 
                    Text="Practice Name:" Width="96px" EnableViewState="False"></asp:Label></td>
            ...
            <b>Update the information for this Practice in the spaces to the left.&nbsp;</b>
            </td>
        </tr>
        <tr>
            <td style="width: 96px" valign="top">
                <asp:Label ID="Label1" runat="server" CssClass="LabelDataEntry" Text="Address:" EnableViewState="False"></asp:Label></td>
            <td style="width: 250px; margin-left: 40px;">
                <asp:TextBox ID="txtAddress1" runat="server" CssClass="TextBoxDataEntry" MaxLength="80" Width="280px" TabIndex="2"></asp:TextBox><br />
                <asp:TextBox ID="txtAddress2" runat="server" CssClass="TextBoxDataEntry" MaxLength="80" Width="280px" TabIndex="3"></asp:TextBox><br />
                <asp:TextBox ID="txtAddress3" runat="server" CssClass="TextBoxDataEntry" MaxLength="80" Width="280px" TabIndex="4"></asp:TextBox>                
            </td>
        </tr>
        <tr>
            <td style="width: 96px">
            ...
            <td style="width: 100px">
                <asp:TextBox ID="txtCity" runat="server" CssClass="TextBoxDataEntry" MaxLength="50" Width="220px" TabIndex="5"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 96px">
                <asp:Label ID="Label4" runat="server" CssClass="LabelDataEntry" Text="State:" EnableViewState="False"></asp:Label></td>
            <td style="width: 100px">
                <asp:TextBox ID="txtState" runat="server" CssClass="TextBoxDataEntry" MaxLength="2" Width="25px" TabIndex="6"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 96px">
                <asp:Label ID="Label5" runat="server" CssClass="LabelDataEntry" Text="Zip:" EnableViewState="False"></asp:Label></td>
            <td style="width: 100px">
                <asp:TextBox ID="txtZip" runat="server" CssClass="TextBoxDataEntry" MaxLength="10" Width="80px" TabIndex="7"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 96px">
                <asp:Label ID="Label7" runat="server" CssClass="LabelDataEntry" Text="Main Phone:" EnableViewState="False"></asp:Label></td>
            <td style="width: 100px">
                <asp:TextBox ID="txtOfficePhone1" runat="server" CssClass="TextBoxDataEntry" MaxLength="12" Width="100px" TabIndex="8"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 96px">
                <asp:Label ID="Label8" runat="server" CssClass="LabelDataEntry" Text="Alternate Phone:" EnableViewState="False"></asp:Label></td>
            <td style="width: 100px">
                <asp:TextBox ID="txtOfficePhone2" runat="server" CssClass="TextBoxDataEntry" MaxLength="12" Width="100px" TabIndex="9"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 96px">
                <asp:Label ID="Label9" runat="server" CssClass="LabelDataEntry" Text="Fax:" EnableViewState="False"></asp:Label></td>
            <td style="width: 100px">
                <asp:TextBox ID="txtFax" runat="server" CssClass="TextBoxDataEntry" MaxLength="12" Width="100px" TabIndex="10"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 96px">
            </td>
        ...
        <tr>
            <td style="width: 96px">
                <asp:Label ID="Label2" runat="server" CssClass="LabelDataEntry" Text="Office Manager:" EnableViewState="False"></asp:Label></td>
            <td style="width: 100px">
                <asp:TextBox ID="txtOfficeManager" runat="server" CssClass="TextBoxDataEntry" MaxLength="50" Width="220px" TabIndex="11"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 96px">
                <asp:Label ID="Label10" runat="server" CssClass="LabelDataEntry" Text="Website URL:" EnableViewState="False"></asp:Label></td>
            <td style="width: 100px">
                <asp:TextBox ID="txtWebsiteURL" runat="server" CssClass="TextBoxDataEntry" MaxLength="250" Width="220px" TabIndex="12"></asp:TextBox></td>
        </tr>
    </table>
    <br />
    <br />
    ...
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True"
        ...
        EmptyDataText="There are no Doctors currently assigned to this Practice.">
        <Columns>
